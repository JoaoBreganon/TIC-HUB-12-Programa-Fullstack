    ...
    <main class="flex-1 flex flex-col max-h-screen overflow-y-auto">
      <header class="bg-white px-8 py-5 border-b border-slate-200 flex justify-between items-center shadow-sm z-10 sticky top-0">
        ...
        <div class="flex items-center gap-3">
          <div class="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-700 font-bold">A</div>
          <div class="text-sm font-medium text-slate-600">Administrador logado</div>
        </div>
      </header>
